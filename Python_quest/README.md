...
<sup>2016년 12월 19일 오후 11:15</sup>
...
먼저, 저커버그가 자신의 Facebook [프로필]([https://www.facebook.com/zuck](https://www.facebook.com/zuck))에 업로드한 [동영상](https://www.facebook.com/4/videos/10103351034741311/)으로 자비스를 만나 볼까요?
...
![자비스 구축을 위해 연결된 시스템 구성](https://cdn.digitaltoday.co.kr/news/photo/201701/102583_151079_1329.jpg)

<sup>자비스 구축을 위해 연결된 시스템 구성</sup>
...
![자비스는 현관문 앞 손님의 얼굴을 인식해 누가 방문했는지 알려줍니다.](https://cdn.digitaltoday.co.kr/news/photo/201701/102583_151080_1329.jpg)

<sup>자비스는 현관문 앞 손님의 얼굴을 인식해 누가 방문했는지 알려줍니다.</sup>
...
![메신저 봇 덕분에 언제 어디서든 자비스에게 메시지 보내기](https://edgio.clien.net/F01/5403389/e740c37fcb26403dabb.JPG?scale=width[740],options[limit])

<sup>메신저 봇 덕분에 언제 어디서든 자비스에게 메시지 보내기</sup>
...
![자비스를 위한 iOS 앱 음성 인식 기능](https://cdn.digitaltoday.co.kr/news/photo/201701/102583_151081_1329.jpg)

<sup>자비스를 위한 iOS 앱 음성 인식 기능</sup>
...
![오픈AI CEO 샘 알트만](https://cdn.aitimes.kr/news/photo/202303/27595_41566_124.jpg)

<sup>오픈AI CEO 샘 알트만 (사진:ABC방송 캡쳐)</sup>
...
그는 이에 대해 "인간의 창의성은 무한합니다. 우리는 이를 통해 새로운 직업과 새로운 할 일을 찾을 것입니다" 라고 덧붙였다. (더 자세한 이날 인터뷰 내용은 아래 <span style="color:red">_사진을 클릭해서 영상을 참고_</span> 하면 된다.)


[![알트만 인터뷰](https://i.abcnewsfe.com/a/1c2bc8b5-d20a-4adc-85bb-e2195fad4e84/sam-altman-7-abc-gmh-230315_1678991270560_hpMain_16x9.jpg)](https://youtu.be/540vzMlf-54?si=upqDKJeKQHzuL3g3) 
...
![그래프](https://cdn.aitimes.kr/news/photo/202303/27595_41564_2253.jpg)
...
또한 그 중에서도 가장 눈에 띄는 변화는 '멀티모달(Multimodal)'로 이전의 챗GPT 및 GPT-3는 텍스트로 제한되었지만 GPT-4는 이미지를 보고 이해하고 설명하고 요청한 사항을 처리한다. 예를 들어, 재료 사진에서 레시피 제안을 제공하고 캡션 및 설명을 작성할 수 있으며, 더 중요한 것은 라벨을 번역하고, 지도를 읽는 등 다양한 분야에서 이해도가 그 이상이라고 한다. (자세한 내용은 본지 15일 보도 [참조](https://cms.aitimes.kr/news/articleView.html?idxno=27571))

---
# 소감 :


프로젝트 제출건으로 마크 저커버그의 "AI 비서 자비스" 기사를 다시 보며 감회가 새로웠다. 제일 먼저 기사날짜에 눈이 갔다. 2016년. 7년이 지나고 그는 자신의 집에서 실험했던 AI 서비스를 모두가 실험할 수 있게 **Llama2** 를 무료로 배포했다. [기사참고](https://modulabs.co.kr/blog/llama-2-intro/) 

자신이 체험한 AI기술의 놀라운 미래변화의 헤게모니를 자본과 기술의 한계점에 두지 않고 '인류 커뮤니티가 자신들의 미래를 개척해 나가길 바라는 마음에서 비롯된 것이 아닐까?'하는 순진한 생각도 해보았다. 왜냐하면 샘 알트만의 기사에도 언급되었듯 인류 커뮤니티에는 'AI 사용에 있어서 안전장치 등 제한을 두지 않을 수도 있으며 어떻게 통제할지 생각해내야 하는데, 그럴 수 있는 시간은 제한돼 있기 때문이다.'

이런 점에서 AI 기술은 *'어떤 일이나 직업에 대체품이 아닌'* 생활과 생산적 활동의 도구로 작용할 수 있도록  **모두의 가치여야 하며 혜택이고 또한 관심과 주의의 대상** 이 되어야 한다는 생각이 들었다. 그래서 오늘도 AI 지식을 함께 공유하고 성장하기를 바라는 우리가 자랑스럽다! 

아이펠 그루님들, 퍼실님들, 파이팅! 입니다 ;-o)